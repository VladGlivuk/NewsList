...
const textButtonStyles =
  'bg-transparent py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none rounded-lg    hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 border-2';
